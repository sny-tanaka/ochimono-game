if (!self.define) {
  ...
  self.define = (s, r) => {
    ...
    let f = {};
    const a = (e) => n(e, l),
      d = { module: { uri: l }, exports: f, require: a };
    i[l] = Promise.all(s.map((e) => d[e] || a(e))).then((e) => (r(...e), f));
  };
}
define(['./workbox-1ef09536'], function (e) {
  ...
  (self.addEventListener('message', (e) => {
    ...
    e.precacheAndRoute(
      [
        { url: 'index.html', revision: '6f677cffe7dc24f863b5faff0a2768c8' },
        ...
        { url: 'assets/index-C9D0tYf5.js', revision: null },
        { url: 'icon-192.png', revision: '8179bef49d2480bac76293141a9851ba' },
        { url: 'icon-512.png', revision: 'a4e8fac1df09f9186affe8d3f3b981bb' },
